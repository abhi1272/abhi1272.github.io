(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BillComponent = /** @class */ (function () {
                function BillComponent(pharma) {
                    this.pharma = pharma;
                }
                BillComponent.prototype.ngOnInit = function () {
                    this.billData();
                };
                BillComponent.prototype.billData = function () {
                    var _this = this;
                    this.pharma.getBillData().subscribe(function (data) {
                        _this.billDataArr = data;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerComponent = /** @class */ (function () {
                function CustomerComponent(pharma) {
                    this.pharma = pharma;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaymentComponent = /** @class */ (function () {
                function PaymentComponent(route, pharma) {
                    this.route = route;
                    this.pharma = pharma;
                }
                PaymentComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.subscribe(function (data) {
                        _this.billId = data.id;
                    });
                    this.getBillData();
                    this.getPaymentHistory();
                };
                PaymentComponent.prototype.getBillData = function () {
                    var _this = this;
                    this.pharma.getSingleBillData(this.billId).subscribe(function (data) {
                        _this.billData = data;
                    });
                };
                PaymentComponent.prototype.getPaymentHistory = function () {
                    var _this = this;
                    this.pharma.getPaymentByBillId(this.billId).subscribe(function (data) {
                        _this.paymemntHistory = data;
                    });
                };
                PaymentComponent.prototype.addAmount = function (paidAmount) {
                    var _this = this;
                    var paymentObj = ({
                        billId: this.billId,
                        paidAmount: paidAmount
                    });
                    this.pharma.addPayment(paymentObj).subscribe(function (data) {
                        var newPayment = 'newPayment';
                        _this.paymemntHistory.push(data[newPayment]);
                    }, function (error) {
                        console.log(error);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PharmaService = /** @class */ (function () {
                ...
                PharmaService.prototype.getCustomerData = function () {
                    return this.http.get(this.baseUrl + "/customers");
                };
                PharmaService.prototype.getBillData = function () {
                    return this.http.get(this.baseUrl + "/bills");
                };
                PharmaService.prototype.getSingleBillData = function (billId) {
                    return this.http.get(this.baseUrl + "/bills/" + billId);
                };
                PharmaService.prototype.getPaymentByBillId = function (billId) {
                    return this.http.get(this.baseUrl + "/payment/" + billId);
                };
                PharmaService.prototype.addPayment = function (paymentObj) {
                    return this.http.post(this.baseUrl + "/payment/" + paymentObj.billId, paymentObj);
                };
                return PharmaService;
            }());
            PharmaService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductComponent = /** @class */ (function () {
                function ProductComponent(pharma) {
                    this.pharma = pharma;
                }
                ProductComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.pharma.getProductData().subscribe(function (data) {
